          ...
          <div class="col-lg-6">
            <div class="platform">
              ...
              <div class="cost d-flex">
                <img src="<?php the_field('c_icon_image');?>" loading="lazy" alt="cost-icon">
                <div class="cost-text">
                  <h3><?php the_field('c_title');?></h3>
                  <p><?php the_field('c_short_description');?></p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            <img src="<?php the_field('c_right_image');?>" loading="lazy"    alt="platfomr-images">
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-12">
            <div class="features-heading d-flex justify-content-center text-center  ">
              <div class="features_text smarter_box" >
                ...
                <p class="section_btn"><?php the_field('h_sub_title');  ?></p>
                <h2><?php the_field('h_title');  ?></h2>
              </div>
            </div>
          </div>
        </div>
               ...
               <div class="row">
                <div class="col-md-6 create-text">
                  <div class="create d-flex align-items-center">
                    ...
                    <h3 ><?php echo get_sub_field('w_title');  ?></h3>
                  </div>
                  <p><?php echo get_sub_field('w_description');  ?></p>
                  <a href="<?php echo get_sub_field('button_url');  ?>" class="btn-1 btn-over"><?php echo get_sub_field('w_button_text');  ?></a>
                </div>
                <div class="col-md-6">
                  <img src="<?php echo get_sub_field('w_right_image')['url'];  ?>"  alt="create-img">
                </div>
               </div>
            </div>
          </div> 
            ...
            <div class="trusted">
              <div class="features-heading d-flex justify-content-center text-center  ">
                <div class="features_text trusted_box" >
                  <p class="section_btn"><?php the_field('t_sub_title');  ?></p>
                  <h2><?php the_field('t_title');  ?></h2>
                </div>
              </div>
              ...
              ?>
                <div class="masud justify-content-center d-flex">
                  <div class="trusted_text1 text-center ">
                    ...
                    <p><?php the_sub_field('client_review');  ?></p>
                    <div class="trusted_img">
                        <img src="<?php the_sub_field('client_photo');  ?>" loading="lazy" alt="James_Toriff">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="features-heading d-flex justify-content-center text-center" >
              <div class="features_text">
                <p class="section_btn"><?php the_field('b_sub_title');  ?></p>
